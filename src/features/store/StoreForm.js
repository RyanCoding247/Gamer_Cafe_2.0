            ...
            <Modal isOpen={modalOpen} size='xl'>
                ...
                <ModalBody>
                    <Formik
                        ...
                        initialValues={{ shirtSize: '', quantity: 0, color: 'Select...', price: `${store[mySelection].price}`, name: '', address: '', address2: '', city: '', cardState: '', zip: '', payType: '', cardName: '', cardNumber: '', expiration: '', cvv: '' }}
                        ...
                        <Form>
                            <Row>
                                ...
                                <Col xs={{ size: '4' }} style={{border: '1px blue solid'}}>
